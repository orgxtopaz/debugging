      ...
      >
        ...
        <List>
          ...
          <Link to={`/adminDashboard`} style={{ fontSize: "40px" }}> <i
            ...
            ></i>&nbsp;&nbsp;<span style={{ paddingLeft: "20px", fontSize: "15px",color:"white", color:"black" }}>Home</span>
            ...
            <Link to={`/adminOrganizational`} style={{ fontSize: "40px" }}> <i
              ...
              style={{ fontSize: "20px", color: "#343a40", paddingLeft: "15px" }}
            ></i>&nbsp;&nbsp;<span style={{ paddingLeft: "20px", fontSize: "15px",color:"white", color:"black" }}>Announcement</span>
            </Link>
            ...
            ></i>&nbsp;&nbsp;<span style={{ paddingLeft: "20px", fontSize: "15px",color:"white", color:"white" }}>Travel Log</span>
            </Link>
            ...
            <Link to={`/createOfficial`} style={{ fontSize: "40px" }}>  <i
              ...
              style={{ fontSize: "20px", color: "#343a40", paddingLeft: "15px" }}
            ></i>&nbsp;&nbsp;<span style={{ paddingLeft: "20px", fontSize: "15px",color:"white", color:"black" }}>Create official</span>
            </Link>
            <br></br>
            <Link to={`/request`} style={{ fontSize: "40px" }}>  <i
              className="bi bi-file-earmark-text"
              style={{ fontSize: "20px", color: "#343a40", paddingLeft: "15px" }}
            ></i>&nbsp;&nbsp;<span style={{ paddingLeft: "20px", fontSize: "15px",color:"white", color:"black" }}>Data</span>
            </Link>
