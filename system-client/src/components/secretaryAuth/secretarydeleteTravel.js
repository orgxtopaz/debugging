...
import secretaryTravels from '../img/travel.svg'

  //CONFIGURING TOASTIFY
toast.configure();

function SecretarydeleteTravel() {
  ...
  const deleteTravel = () => {
    ...
    function save() {
      ...
      Axios.delete(`https://orgserver.herokuapp.com/deleteTravel/${travelId}`,{
        ...
        (response) => {
          history.push("/secretaryTravel"); //GOING BACK TO HOME PAGE / MAIN PAGE
...
export default SecretarydeleteTravel;
